...
- Extract: **company name**, **role title**, **department** (if mentioned), **location**, and **language** of the posting (usually English).
...
- **Match the language of the job posting** (in the US this is nearly always English; a non-English posting gets a cover letter in that language)
